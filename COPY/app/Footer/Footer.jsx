...
whileInView={{ transform: "translateX(0px)",transition: { duration: 1.2 }}}
   className=" flex justify-center items-center gap-4 relative pb-4  flex-wrap">
          <button className="bg-[#00695f] w-96 ... text-white font-semibold text-lg border-none rounded-3xl h-16 w-64 order-2 sm:order-1">اشترك الآن</button>
          <input type="email" className="p-4 h-16 ... sm:order-2 font-semibold text-lg sm:w-96 ... w-44 ... rounded-3xl bg-white text-right" id="outlined-basic" placeholder="البريد الالكتروني" />
